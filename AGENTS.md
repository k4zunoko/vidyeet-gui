# vidyeet-gui
**MuxAPIをラップしたcli(`.\bin\vidyeet.exe`)を実行するデスクトップアプリケーション**
...
**AGENT.mdとdocs/配下のドキュメント群は、GitHub CopilotなどのLLM言語モデルがプロジェクト状況を正確に理解するために設計されています。**
...
4. **ナビゲーション**: AGENT.mdから各ドキュメントへの明確な案内
5. **文脈**: LLMが次回セッションで読んでも理解できる十分な文脈情報

### 注意事項

- **AGENT.mdに詳細を書かない**: 詳細はdocs/配下に分離
